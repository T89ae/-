      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
          ...
          >
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className={`flex-1 py-4 rounded-2xl font-bold text-white transition-all shadow-lg ${
                    ...
                    type === 'warning' ? 'bg-amber-600 hover:bg-amber-700 shadow-amber-200' : 'bg-blue-600 hover:bg-blue-700 shadow-blue-200'
                  }`}
                >
                  {confirmText}
                </button>
            ...
            <button 
              onClick={onClose}
              className="absolute top-6 left-6 p-2 hover:bg-slate-50 rounded-xl text-slate-400 transition-colors"
            >
              <X size={20} />
            </button>
          </motion.div>
